$(document).ready(function () {
    ...
    $('#submit').click(function (e) {
        ...
        if ($('#fname').val() === "") {
            ...
            $('#processtip').text('').css("color", "#ffcc00");
            $.getJSON("/tools/search", {
                ...
                var data = {'a': [{
                    ...
                    if (mydatasets.length == 0) {
                        ...
                        $('#aftersubmit').html('<p>Top 3 closest genes within the same clusters: <a href="/tools/">ERAL1</a>,\
                                                 <a href="/tools/">AUTS2</a>, \
                                                 <a href="/tools/">PPP4R4</a></p>')
        ...
        if ($('#myfile').val() === "" && $('.textarea').text() === "") {
            ...
            $.ajax(ajaxParameters)
                .done(
                    function (reportID) {
                        // TODO: MODIFY below to generate a chart.js 
